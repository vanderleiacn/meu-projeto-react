...
function MarcaAnoLancamento({marca, ano_lancamento}){
    return(
        <>      
     ...
     MarcaAnoLancamento.propTypes ={ /*propTypes propriedade do componente*/
   ...
   MarcaAnoLancamento.defaultProps ={/*quando se declara o defaultProps o requerid nao funciona*/
    marca: 'Faltou a marca',
    ano_lancamento: 0,
   }

         
export default MarcaAnoLancamento